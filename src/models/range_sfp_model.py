"""Lightweight classifier for Range-SFP strategy.

Predicts P(win) — probability that TP gets hit before SL.
~1.5K params — same architecture as ThreeTapClassifier.
"""
...
class RangeSFPClassifier(nn.Module):
    def __init__(self, n_features=20, window=30, hidden=22):
        super().__init__()
