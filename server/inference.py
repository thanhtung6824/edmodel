...
Model outputs (B, 6):
  ...
  [1]: TP1 distance (softplus, adaptive quantile)
  [2]: TP2 distance (softplus, adaptive quantile)
  [3]: tau1 — adaptive quantile for TP1
  [4]: tau2 — adaptive quantile for TP2
  [5]: ttp — time-to-peak ∈ [0, 1]
"""
